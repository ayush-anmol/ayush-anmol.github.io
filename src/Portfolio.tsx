...
const NAME = "Ayush Anmol";
const HANDLE = "ayush-anmol";
const TAGLINE =
...
const BIO_P2_LINK = "a paper";
const BIO_P2_AFTER = " on cover song detection along the way.";
const BIO_P2 = BIO_P2_BEFORE + BIO_P2_LINK + BIO_P2_AFTER;
...
interface PreviouslyItem {
  post: string;
  company: string;
  work: string;
}
// When a role starts, fill this in — it renders as a "Now" slot above Previously.
// const CURRENT_ROLE: PreviouslyItem | null = {
//   post: "AI Engineer",
//   company: "company",
//   work: "building agentic RAG systems for <domain>",
// };
const CURRENT_ROLE: PreviouslyItem | null = null;

const PREVIOUSLY: PreviouslyItem[] = [
